...
<div class="woocom-login-page">
    <div class="container mx-auto px-4 py-10">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-14 h-14 bg-secondary rounded-2xl mb-4" style="margin: 0 auto; display: flex;">
            ...
            <div class="woocom-panel bg-white rounded-2xl p-6 md:p-8">
                ...
                <?php if ( $reg_enabled ) : ?>
                    ...
                    <div class="woocom-login-tabs flex border-b border-gray-100 mb-6">
                        <button type="button" class="woocom-tab-btn flex-1 text-center pb-3 font-bold text-[15px] border-b-2 <?php echo $active_tab === 'login' ? 'border-secondary text-[#253D4E]' : 'border-transparent text-gray-400'; ?>" data-tab="login">
                            <?php esc_html_e( 'Login', 'woocommerce' ); ?>
                        </button>
                        <button type="button" class="woocom-tab-btn flex-1 text-center pb-3 font-bold text-[15px] border-b-2 <?php echo $active_tab === 'register' ? 'border-secondary text-[#253D4E]' : 'border-transparent text-gray-400'; ?>" data-tab="register">
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
                        ...
                        <div class="flex items-center justify-between mb-5 flex-wrap gap-2">
                            ...
                            <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"
                               class="text-[13px] text-secondary font-semibold hover:underline">
                        ...
                        <button type="submit"
                            class="woocommerce-button button woocommerce-form-login__submit w-full bg-secondary text-white font-bold py-3 rounded-xl text-[14px] hover:opacity-90 transition-all uppercase tracking-wide"
...
.woocom-eye-btn:hover { color: var(--color-secondary, #F7A501); }

/* Remember checkbox */
.woocommerce-form-login__rememberme input[type="checkbox"] {
    accent-color: var(--color-secondary, #F7A501);
...
(function ($) {
    ...
    jQuery(document).ready(function($) {
        $('.woocom-tab-btn').on('click', function(e) {
            ...
            $('.woocom-tab-btn').removeClass('border-secondary text-[#253D4E]').addClass('border-transparent text-gray-400');
            $(this).removeClass('border-transparent text-gray-400').addClass('border-secondary text-[#253D4E]');
