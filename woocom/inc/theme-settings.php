...
function woocom_register_unified_settings() {
    ...
    // Active Offers Settings
    register_setting('woocom-settings-group', 'woocom_offer_1_badge', array('default' => 'MOST POPULAR'));
    register_setting('woocom-settings-group', 'woocom_offer_1_qty', array('default' => '2'));
    register_setting('woocom-settings-group', 'woocom_offer_1_discount', array('default' => '6'));

    register_setting('woocom-settings-group', 'woocom_offer_2_badge', array('default' => 'BEST VALUE'));
    register_setting('woocom-settings-group', 'woocom_offer_2_qty', array('default' => '5'));
    register_setting('woocom-settings-group', 'woocom_offer_2_discount', array('default' => '7'));

    register_setting('woocom-settings-group', 'woocom_offer_3_badge', array('default' => 'MOST SAVINGS'));
    register_setting('woocom-settings-group', 'woocom_offer_3_qty', array('default' => '10'));
    register_setting('woocom-settings-group', 'woocom_offer_3_discount', array('default' => '10'));
    register_setting('woocom-settings-group', 'woocom_offer_3_coupon', array('default' => 'LARA10'));
}
...
function woocom_unified_theme_settings_page() {
    $allowed_tabs = array('branding', 'header', 'ticker', 'banners', 'layout', 'collections', 'cart', 'offers', 'contact', 'footer', 'language', 'analytics', 'demo_import');
    ...
    <div class="woocom-admin-wrap">
        ...
        <div class="woocom-admin-container">
            <div class="woocom-admin-sidebar">
                ...
                <a href="?page=woocom-settings&tab=offers" class="woocom-admin-nav-item <?php echo $active_tab == 'offers' ? 'active' : ''; ?>">
                    <span class="dashicons dashicons-tag"></span> Active Offers
                </a>
            ...
            <div class="woocom-admin-content">
                <form method="post" action="options.php">
                    ...
                    <?php elseif ($active_tab == 'offers') : ?>
                        <div class="section-header">
                            <h2>Active Offers Settings</h2>
                            <p>Configure the quantity discount tiers (Active Offers) displayed on the single product page.</p>
                        </div>
                        <div class="form-grid">
                            <h3 style="grid-column: 1 / -1; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-top: 10px; font-weight: 800; color: #1e293b;">Card 1 Settings</h3>
                            <div class="form-row">
                                <div class="form-label">Badge Text</div>
                                <td><input type="text" name="woocom_offer_1_badge" value="<?php echo esc_attr(get_option('woocom_offer_1_badge', 'MOST POPULAR')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Target Quantity</div>
                                <td><input type="number" name="woocom_offer_1_qty" value="<?php echo esc_attr(get_option('woocom_offer_1_qty', '2')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Discount Percentage (%)</div>
                                <td><input type="number" name="woocom_offer_1_discount" value="<?php echo esc_attr(get_option('woocom_offer_1_discount', '6')); ?>" class="form-input-text"></td>
                            </div>

                            <h3 style="grid-column: 1 / -1; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-top: 20px; font-weight: 800; color: #1e293b;">Card 2 Settings</h3>
                            <div class="form-row">
                                <div class="form-label">Badge Text</div>
                                <td><input type="text" name="woocom_offer_2_badge" value="<?php echo esc_attr(get_option('woocom_offer_2_badge', 'BEST VALUE')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Target Quantity</div>
                                <td><input type="number" name="woocom_offer_2_qty" value="<?php echo esc_attr(get_option('woocom_offer_2_qty', '5')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Discount Percentage (%)</div>
                                <td><input type="number" name="woocom_offer_2_discount" value="<?php echo esc_attr(get_option('woocom_offer_2_discount', '7')); ?>" class="form-input-text"></td>
                            </div>

                            <h3 style="grid-column: 1 / -1; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px; margin-top: 20px; font-weight: 800; color: #1e293b;">Card 3 Settings</h3>
                            <div class="form-row">
                                <div class="form-label">Badge Text</div>
                                <td><input type="text" name="woocom_offer_3_badge" value="<?php echo esc_attr(get_option('woocom_offer_3_badge', 'MOST SAVINGS')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Target Quantity</div>
                                <td><input type="number" name="woocom_offer_3_qty" value="<?php echo esc_attr(get_option('woocom_offer_3_qty', '10')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Discount Percentage (%)</div>
                                <td><input type="number" name="woocom_offer_3_discount" value="<?php echo esc_attr(get_option('woocom_offer_3_discount', '10')); ?>" class="form-input-text"></td>
                            </div>
                            <div class="form-row">
                                <div class="form-label">Coupon Code</div>
                                <td><input type="text" name="woocom_offer_3_coupon" value="<?php echo esc_attr(get_option('woocom_offer_3_coupon', 'LARA10')); ?>" class="form-input-text"></td>
                            </div>
                        </div>
                    ...
                    $all_fields = array(
                        ...
                        'offers' => array('woocom_offer_1_badge', 'woocom_offer_1_qty', 'woocom_offer_1_discount', 'woocom_offer_2_badge', 'woocom_offer_2_qty', 'woocom_offer_2_discount', 'woocom_offer_3_badge', 'woocom_offer_3_qty', 'woocom_offer_3_discount', 'woocom_offer_3_coupon'),
